  ...
  return (
    <div className="flex items-center justify-center gap-3 sm:gap-5 font-mono text-xs uppercase tracking-[0.15em] text-black/50">
      <div className="flex items-center gap-2">
        <span className="font-bold text-black/70">Based in Semarang</span>
      </div>
...
const OrbitingDecoration = ({ icon: Icon, delay, className, isRevealed, enableAmbientMotion }) => (
  <Gsap.div
    ...
    className={`absolute flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-cyan-500/20 bg-white/60 backdrop-blur-lg shadow-[0_10px_30px_rgba(6,182,212,0.12)] ${className}`}
...
const HeroSection = memo(function HeroSection({ isRevealed = true }) {
  ...
  return (
    <header
      ref={containerRef}
      id="hero-section"
      className="min-h-[100svh] w-full relative bg-[#FAF9F6] selection:bg-cyan-300 selection:text-black overflow-hidden flex flex-col items-center justify-center pt-16 pb-16"
    >
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle at 18% 18%, rgba(34, 211, 238, 0.14), transparent 44%), radial-gradient(circle at 82% 15%, rgba(6, 182, 212, 0.1), transparent 42%), radial-gradient(circle at 50% 85%, rgba(103, 232, 249, 0.09), transparent 50%), linear-gradient(135deg, rgba(34, 211, 238, 0.02), rgba(234, 179, 8, 0.01))'
          }}
        />
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center relative w-full mb-4 md:mb-5">
          ...
          <Gsap.h1
            ...
            className="text-[clamp(1rem,5.5vw,9rem)] font-black uppercase tracking-tight text-transparent leading-[0.88] font-outline-fallback"
          >
            MUHAMMAD
          </Gsap.h1>
          ...
          <Gsap.h1
            ...
            className="text-[clamp(1.1rem,6.8vw,9rem)] font-black uppercase tracking-tight text-black leading-[0.88] mt-2 sm:mt-0"
          >
            HABIBURRAHMAN
          </Gsap.h1>
        ...
        >
          <button
            ...
            className="group flex items-center gap-2 bg-black text-white px-6 py-3 font-mono text-sm font-bold uppercase tracking-wider hover:bg-cyan-400 hover:text-black transition-all duration-300 cursor-pointer"
          >
          ...
          <a
            href="/cv.pdf"
            download
            className="group flex items-center gap-2 bg-transparent text-black border-2 border-black px-6 py-3 font-mono text-sm font-bold uppercase tracking-wider hover:bg-black hover:text-cyan-400 transition-all duration-300"
          >
