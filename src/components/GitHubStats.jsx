...
const GITHUB_USERNAME = 'Habiburrahman2007';
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="mb-12 md:mb-16 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                    ...
                    <Gsap.a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-3 w-fit border border-cyan-400/30 text-cyan-400 px-6 py-3 hover:bg-cyan-400 hover:text-black transition-all font-mono text-sm font-bold uppercase tracking-[0.14em] md:tracking-[0.2em] group"
                    >
                        <Terminal size={16} />
                        Launch_Profile
                    ...
                    >
                        <div className="flex justify-between items-start border-b border-white/10 pb-6 mb-8">
                            ...
                            <div className="hidden sm:flex items-center gap-2 font-mono text-xs uppercase tracking-[0.12em] md:tracking-[0.16em] text-white/40">
                                ...
                                <span className="w-3 h-3 bg-[#164e63]" />
                                <span className="w-3 h-3 bg-[#0e7490]" />
                                <span className="w-3 h-3 bg-[#06b6d4]" />
                                <span className="w-3 h-3 bg-[#22d3ee] mr-2" />
                                More
                            </div>
                        </div>
